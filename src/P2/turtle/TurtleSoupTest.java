...
public class TurtleSoupTest {
	...
	/*对我自行编写的函数 寻找点集中最左下点的坐标的函数
	 * 进行测试
	 */
	@Test
	public void theLeftLowPointTest() {
		...
		points.add(p110);
		points.add(p12);
		double a =TurtleSoup.theLeftLowPoint(points).x();
		assertEquals(true, a==1);
		double b =TurtleSoup.theLeftLowPoint(points).y();
	 ...
	 */
	@Test
	public void initFacingAngleTest() {
		double a =TurtleSoup.initFacingAngle();
		assertTrue(a==0);
	}
	/*
	 * Test nextPoint
	...
	public void nextPointTest() {
		...
		points.add(p110);
		points.add(p1010);
		double ax =TurtleSoup.nextPoint(points, p11, p11).x();
		assertEquals(1.0,ax,0.01);
		double ay =TurtleSoup.nextPoint(points, p11, p11).y();
		assertEquals(10,ay,0.01);
		double bx =TurtleSoup.nextPoint(points, p110, p11).x();
		assertEquals(10,bx,0.01);
		double by =TurtleSoup.nextPoint(points, p110, p11).y();
		assertEquals(10,by,0.01);
